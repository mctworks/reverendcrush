...
function About(){
    ...
    return (<React.Fragment>
        ...
        <Image
            className="shitpic"
            src="/img/dudecommission_hunty.jpg"
            alt='Poorly colored lineart of Reverend Crush yelling "SHIT!" at a glowing monitor with a stylized "GAME OVER" on the screen.'
            width={500}
            height={300}
            layout="responsive"
        />
